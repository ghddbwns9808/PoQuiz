...
import com.ssafy.pokemon.service.rank.RankLowService;
...
@RestController
@RequestMapping("/rank-low")
@CrossOrigin("*")
@Tag(name = "RankLow", description = "Low Rank API")
public class RankLowController {

    @Autowired
    private RankLowService rls;
