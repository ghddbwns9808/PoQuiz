...
import com.ssafy.pokemon.service.rank.RankHighService;
...
@RestController
@RequestMapping("/rank-high")
@CrossOrigin("*")
@Tag(name = "RankHigh", description = "High Rank API")
public class RankHighController {
    @Autowired
    private RankHighService rhs;
