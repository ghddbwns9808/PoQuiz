...
import com.ssafy.pokemon.service.rank.RankHighestService;
...
@RestController
@RequestMapping("/rank-higest")
@CrossOrigin("*")
@Tag(name = "RankHighest", description = "Highest Rank API")
public class RankHighestController {
    @Autowired
    RankHighestService rhs;
